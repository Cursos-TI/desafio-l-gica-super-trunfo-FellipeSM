...
char estado_1[5]; // Uma letra que represente o estado de 'A' à 'H'.
char codigo_carta_1[5]; // Letra do estado + um numero de 01 a 04.
...
PIB_per_capita_1 =  (PIB_1*10000000.0) / populacao_1;
...
PIB_per_capita_2 =  (PIB_2*10000000.0) / populacao_2;
...
case 5:
    ...
    printf("Carta 1: %s X Carta 2: %s\n", nome_cidade_1, nome_cidade_2);
    printf("Densidade Populacional da carta 1 %s: %.3f hab/km²\n", nome_cidade_1, densidade_populacional_1);
    printf("Densidade Populacional da carta 2 %s: %.3f hab/km²\n", nome_cidade_2, densidade_populacional_2);
